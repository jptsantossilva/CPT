...
- Added global PnL and its percentage return on net invested capital to notification email and preview content, calculated against the same sync snapshot used for the notification.
